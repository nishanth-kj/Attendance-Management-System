        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2 space-y-6">
                    <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100 flex flex-col md:flex-row items-center gap-8 bg-gradient-to-br from-white to-blue-50/30">
                        <div className="w-full md:w-1/2 space-y-4 text-center md:text-left">
                            ...
                            <button
                                ...
                                className="inline-flex items-center gap-2 px-8 py-4 bg-blue-600 text-white rounded-md font-bold shadow-xl hover:bg-blue-700 hover:scale-105 transition-all active:scale-95 group"
                            >
                        ...
                        <div className="w-full md:w-1/2 grid grid-cols-2 gap-4">
                            <button
                                ...
                                className="p-4 bg-white border border-gray-200 rounded-md shadow-sm hover:border-blue-500 hover:shadow-md transition-all flex flex-col items-center gap-2 group"
                            >
                            ...
                            <button
                                className="p-4 bg-white border border-gray-200 rounded-md shadow-sm hover:border-indigo-500 hover:shadow-md transition-all flex flex-col items-center gap-2 group"
                            >
                            ...
                            <button
                                className="p-4 bg-white border border-gray-200 rounded-md shadow-sm hover:border-amber-500 hover:shadow-md transition-all flex flex-col items-center gap-2 group"
                            >
                            ...
                            <button
                                className="p-4 bg-white border border-gray-200 rounded-md shadow-sm hover:border-green-500 hover:shadow-md transition-all flex flex-col items-center gap-2 group"
                            >
                ...
                <div className="md:col-span-1 space-y-6">
                    ...
                    <div className="bg-gray-900 p-6 rounded-lg shadow-xl text-white">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <span className="flex items-center gap-1 text-[10px] font-bold text-green-400 bg-green-400/10 px-2 py-0.5 rounded-sm ring-1 ring-green-400/20">
                                <span className="w-1 h-1 bg-green-400 rounded-sm animate-pulse"></span>
                                Active
                            </span>
                        </div>
